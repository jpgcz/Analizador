...
public class Contadores {
   int linea=1,error,identificador,comentarios,palabrasreservadas,cedec,cebin,cehex,ceoct,ctexto,cfloat,cncomp,ccar,aritmeticos,monogamo,logico,relacionales,bit,identidad,puntucion,agrupacion,asignacion;

    public Contadores(int linea,int error, int identificador, int comentarios, int palabrasreservadas, int cedec, int cebin, int cehex, int ceoct, int ctexto, int cfloat, int cncomp, int ccar, int aritmeticos, int monogamo, int logico,int relacionales ,int bit, int identidad, int puntucion, int agrupacion, int asignacion) {
        this.linea=linea;
        this.error = error;
